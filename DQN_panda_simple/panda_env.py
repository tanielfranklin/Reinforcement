...
class Panda_RL(object):
    ...
    def step(self,a):
        ...
        if self.distance()<0.01:
            ...
            info=["Done",["Completed"]]
            r=200
        elif col or joint_limits:
            done=True
            info=["terminated",reached_limits]
            r=-300
